/**
 * Dialog — shadcn/ui primitive over @radix-ui/react-dialog.
 *
 * The plain modal counterpart to AlertDialog: dismissible by overlay click,
 * Escape, or an explicit close (X). Used for the merge conflict dialog, where
 * Cancel/Escape/overlay all mean "abandon the merge, leave the spans untouched."
 * Includes a built-in close (X) in the top-right corner of the content.
 */
